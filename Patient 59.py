...
# Given data
gfr_values = np.array([52.57, 57.21, 49.13, 26.86, 36.56, 37.03, 33.09, 24.65, 36.66, 29.78, 29.85, 29.35, 21.61])
times = np.array([42, 91, 189, 302, 391, 827, 1170, 1219, 1654, 2213, 2492, 2849, 3317])
dt = 0.1
a = 5.58E-07
b = -2.88E-05
lmbda = 0.1166
...
plt.title('Estimated GFR (EKF) for Patient 59', fontsize=20)
plt.legend()
plt.grid(True)
plt.show()
...
# Given data
observations = np.array([52.57, 57.21, 49.13, 26.86, 36.56, 37.03, 33.09, 24.65, 36.66, 29.78, 29.85, 29.35, 21.61])
times = np.array([42, 91, 189, 302, 391, 827, 1170, 1219, 1654, 2213, 2492, 2849, 3317])
dt = 0.1
a = 5.58E-07
b = -2.88E-05
...
plt.xlabel('Time[days]', fontsize=20)
plt.ylabel('GFR[ml/min]', fontsize=20)
plt.title('True GFR vs Estimated GFR (UKF) for Patient 59', fontsize=20)
plt.legend()
plt.grid(True)
plt.show()
...
plt.xlabel('Time [days]', fontsize=20)
plt.ylabel('GFR [ml/min]', fontsize=20)
plt.title('True GFR vs Estimated GFR (UKF) for Patient 59', fontsize=15)
plt.legend()
plt.grid(True)
plt.show()
...
plt.xlabel('Time [days]', fontsize=20)
plt.ylabel('GFR[ml/min]', fontsize=20)
plt.title('True GFR vs Estimated GFR (PF) for Patient 59 with Systematic Resampling', fontsize=15)
plt.legend()
plt.grid(True)
plt.show()
...
# Run the Particle Filter with systematic resampling using interpolated GFR data
...
plt.title('PF with Systematic Resampling for Patient 59')
plt.legend()
plt.grid(True)
