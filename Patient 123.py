...
# Given data
gfr_values = np.array([91.13, 81.86, 81.24, 88.12, 49.19, 58.78, 62.26, 62.03, 63.11, 57.36, 55.00, 56.44])
times = np.array([42, 92, 183, 394, 651, 759, 1117, 1313, 1929, 2223, 2587, 3280])
dt =0.1
a = 2.32E-07
b = -2.39E-05
lmbda = 0.0323
...
plt.title('Estimated GFR (EKF) for Patient 123', fontsize=20)
plt.legend()
plt.grid(True)
plt.show()
...
# Given data
observations = np.array([91.13, 81.86, 81.24, 88.12, 49.19, 58.78, 62.26, 62.03, 63.11, 57.36, 55.00, 56.44])
times = np.array([42, 92, 183, 394, 651, 759, 1117, 1313, 1929, 2223, 2587, 3280])
dt = 0.1
a = 2.32E-07
b = -2.39E-05
...
plt.xlabel('Time[days]', fontsize=20)
plt.ylabel('GFR[ml/min]', fontsize=20)
plt.title('True GFR vs Estimated GFR (UKF) for Patient 123', fontsize=20)
plt.legend()
plt.grid(True)
plt.show()
...
plt.xlabel('Time [days]', fontsize=20)
plt.ylabel('GFR[ml/min]', fontsize=20)
plt.title('True GFR vs Estimated GFR (PF) for Patient 123 with Systematic Resampling', fontsize=15)
plt.legend()
plt.grid(True)
plt.show()
...
plt.title('PF with Systematic Resampling for Patient 123')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()
