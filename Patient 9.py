...
# Given data
gfr_values = np.array([9.23,17.67,18.6,22.7,23.46,23.46,25.63,24.3,17.49,14.28,19.97,16.35])
times = np.array([8,26,68,180,333,454,680,1099,1506,1912,2192,2633])
dt = 0.1
a = 8.7E-07
b = -3.3E-05
lmbda = 0.0378
...
plt.title('Estimated GFR (EKF) for Patient 9', fontsize=20 )
plt.legend()
plt.grid(True)
plt.show()
...
# Given data
observations = np.array([9.23,17.67,18.6,22.7,23.46,23.46,25.63,24.3,17.49,14.28,19.97,16.35])
times = np.array([8,26,68,180,333,454,680,1099,1506,1912,2192,2633])
dt = 0.1
a = 8.7E-07
b = -3.3E-05
...
plt.xlabel('Time[days]',  fontsize=20)
plt.ylabel('GFR[ml/min]', fontsize=20 )
plt.title('True GFR vs Estimated GFR (UKF) for Patient 9', fontsize=20 )
plt.legend()
plt.grid(True)
plt.show()
...
plt.xlabel('Time [days]', fontsize=20 )
plt.ylabel('GFR[ml/min]', fontsize=20)
plt.title('True GFR vs Estimated GFR (PF) for Patient 9 with Systematic Resampling', fontsize=15 )
plt.legend()
plt.grid(True)
plt.show()
...
plt.title('PF with Systematic Resampling for Patient 9')
plt.legend()
plt.grid(True)
